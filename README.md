...
* Takes user input for conditions and provides example inputs
* Calcultes motion using Euler methos, RK4, and Exact solutions
...
The visualization I created uses:
